...
def json_merge_plot_points(
    tool_name: str,
    source_jsons: List[str], # Merge runtime passes list of strings
        ...
        if y_axis_from_zero:
            ...
            if valid_y:
                ...
                if d_min > 0:
                    ...
                    if curr_ymax >= 0: target_ax.set_ylim(top=data_max + 0.05 * d_range)
...
regist_merge_tool(json_merge_plot_points)